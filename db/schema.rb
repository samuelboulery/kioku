...
ActiveRecord::Schema.define(version: 2020_03_06_142348) do
  ...
  create_table "photographers", force: :cascade do |t|
    ...
    t.index ["invitation_token"], name: "index_photographers_on_invitation_token", unique: true
    t.index ["invitations_count"], name: "index_photographers_on_invitations_count"
    t.index ["invited_by_id"], name: "index_photographers_on_invited_by_id"
    t.index ["invited_by_type", "invited_by_id"], name: "index_photographers_on_invited_by_type_and_invited_by_id"
